...
describe("VsCodeIntegratedClaudeCode", () => {
    ...
    beforeEach(() => {
        ...
        mockFileContextTracker = new FileContextTracker(mockClineProvider, "test-task-id") as jest.Mocked<FileContextTracker>
    ...
    describe("createMessage", () => {
        it("should proxy to ClaudeCodeHandler.createMessage", async () => {
            ...
            jest.mocked(ClaudeCodeHandler.prototype.createMessage)
                .mockImplementation((systemPrompt, messages) => mockStream)
            ...
            jest.mocked(vscode.workspace.fs.readFile).mockResolvedValue(
                Buffer.from("// Example file content")
            )
    ...
    describe("completePrompt", () => {
        it("should proxy to ClaudeCodeHandler.completePrompt", async () => {
            ...
            jest.mocked(ClaudeCodeHandler.prototype.completePrompt)
                .mockResolvedValue("Completion result")
    ...
    describe("File detection and handling", () => {
        it("should detect and handle file modifications", async () => {
            // Setup mock implementation for ClaudeCodeHandler.createMessage with proper ApiStreamChunk types
            const mockStream = (async function* () {
                yield { type: "text" as const, text: "I've created a new file src/example.ts with the following content:" }
                yield { type: "text" as const, text: "```typescript\nfunction hello() {\n  console.log('Hello world');\n}\n```" }
            })()
